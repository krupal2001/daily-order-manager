...
import { getApplicablePrice, getPreviousDateStr, getNextDateStr } from '../services/calculationService';
  ...
  const pricesMap = useMemo(() => {
    ...
    activeShopkeepers.forEach((sk) => {
      ...
      activeProducts.forEach((prod) => {
        map[sk.id][prod.id] = getApplicablePrice(sk.id, prod.id, priceMappings, products);
      });
    });
    return map;
